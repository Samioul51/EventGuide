            ...
            <div className='bg-[#6897ff] py-[50px]'>
                ...
                <div className='w-full max-w-[1440px] mx-auto flex flex-col items-center lg:items-stretch lg:flex-row lg:justify-between gap-[50px]'>
                    ...
                    <div className='w-full max-w-[60%] flex flex-col justify-center p-[30px] bg-white rounded-[10px] shadow-lg'>
                        ...
                        <p className='font-bold border-b-2 border-gray-300 pb-2 mb-[16px] text-black'>DESCRIPTION:</p>
                        <p className='font-medium text-justify mb-[50px] text-black'>{fullDescription}</p>


                        <p className='font-bold border-b-2 border-gray-300 pb-2 mb-[16px] text-black'>CONTACT DETAILS:</p>
                        <div className='bg-gray-100 p-[8px] rounded-lg mb-[50px]'>
                            <p className='font-medium text-black'>DATE: {date}</p>
                            <p className='font-medium text-black'>LOCATION: {location}</p>

                        </div>
                        <div>
                            <p className='font-bold text-xl text-green-700 mb-[8px] text-black'>PRICE: {price}</p>
                        </div>
